...
const WHATSAPP_NUMBER = '201005798781'
const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}`
const YOUTUBE_URL = 'https://www.youtube.com/@mr.eslamrabea9564'
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">
          ...
          <div className="space-y-5">
            <Link href="/" className="inline-block">
              <span className="text-3xl font-payback font-bold text-primary uppercase italic">
                INT-PHYSICS
              </span>
            </Link>
